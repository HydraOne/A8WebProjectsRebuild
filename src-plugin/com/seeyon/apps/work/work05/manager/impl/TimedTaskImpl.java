...
public class TimedTaskImpl implements  TimedTask{
    ...
    public void initiateThePaymentProcess() {
        ...
        //拼接url为rest接口
        String timerRestUrlString = AppContext.getSystemProperty("demandConfiguration.nativePostRestUrlCtrls");
        timerRestUrlString+="?token="+tokenString;
        String templateCode = AppContext.getSystemProperty("demandConfiguration.bottomSheetOfContractFile1");
        ...
        for (Object o : resultList) {
            ...
            try {
                ...
                log.error("获取formBean失败——lidan",e);//error
            }
            //document
